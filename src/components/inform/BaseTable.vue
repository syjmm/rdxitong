    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-tickets"></i> 通知列表</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="select_word" placeholder="通知标题" class="handle-input mr10"></el-input>
            ...
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="title" label="通知标题" width="150" align="center">
                </el-table-column>
        ...
        <el-dialog title="查看" :visible.sync="editVisible" width="50%">
            <el-form ref="form" :model="seedata" label-width="100px">
                ...
                <el-form-item label="公告内容：" width="50%">
